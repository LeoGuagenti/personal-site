...
//menu nav listeners
document.getElementById('m1').addEventListener("click", function(){scroll(home), false});
...
document.getElementById('m10').addEventListener("click", function(){scroll(home), false});
document.getElementById('m11').addEventListener("click", function(){scroll(about), false});
document.getElementById('m12').addEventListener("click", function(){scroll(projects), false});
document.getElementById('m13').addEventListener("click", function(){scroll(contact), false});
...
document.getElementById('l2').addEventListener("click", function(){window.location = "https://github.com/LeoGuagenti/web-crawler", false});
